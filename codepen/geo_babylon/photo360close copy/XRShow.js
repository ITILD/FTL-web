...
class XRShow {
  ...
  createScence() {
    ...
    this.scene = new BABYLON.Scene(this.engine); // 创建一个场景scene
    this.scene.clearColor = new BABYLON.Color4(0, 0, 0, 0); //背景 
    // 添加一个相机，并绑定鼠标事件
    ...
    // 默认视角级别
    this.zoomLevel = 0.75;
    this.dome = new BABYLON.PhotoDome("testdome", "./textures/4.JPG", { resolution: 32, size: 1000, useDirectMapping: false }, this.scene);
