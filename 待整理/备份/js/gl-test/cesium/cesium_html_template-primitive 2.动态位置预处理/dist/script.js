...
// let geometryInstancesTest =JSON.parse(JSON.stringify(geometryInstances1)) 
...
let onchange = (firstvalue,secondvalue)=> {
  myWorker.postMessage([firstvalue,secondvalue]);
  console.log('Message posted to worker');
}
let indexWorker = 0
setInterval(() => {
  onchange(indexWorker,indexWorker+1000)
  indexWorker++
}, 1000);
...
myWorker.onmessage1 = function(e) {
  // result.textContent = e.data;
  console.log('Message111111111111',e.data);
}